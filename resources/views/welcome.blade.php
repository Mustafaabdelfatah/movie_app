                        ...
                        <div class="movie__cta my-4">
                            ...
                            @auth
                                <a href="#" class="btn btn-outline-light text-capitalize movie__fav-btn">
                                    <span class=" movie__fav-icon movie-{{ $latest_movie->id }} {{ $latest_movie->is_favored ? 'heart-shape' : 'fa fa-heart-o' }}"
                            ...
                            @else
                                <a href="{{ route('login') }}" class="btn btn-outline-light text-capitalize"><span class="fa fa-heart-o"></span> add to favorite</a>
                            @endauth
                        </div>
                    </div><!-- end of col -->
                ...
                <div class="movie p-0">
                    ...
                    <div class="movie__details text-white">
                        ...
                        <div class="d-flex movie__cta">
                            ...
                            @auth
                                <i class=" {{ $movie->is_favored ? 'heart-shape' : 'fa fa-heart-o'}} fa-1x align-self-center movie__fav-icon movie-{{ $movie->id }}"
                            ...
                            @else
                                <a href="{{ route('login') }}" class="text-white align-self-center"><i class="fa fa-heart-o fa-1x align-self-center movie__fav-icon"></i></a>
                            @endauth
                        </div>
