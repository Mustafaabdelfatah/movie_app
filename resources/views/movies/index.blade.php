                        ...
                        <div class="movie col-md-3  my-3 p-0">
                            ...
                            <div class="movie__details text-white">
                                ...
                                <div class="d-flex movie__cta">
                                    ...
                                    @auth
                                        <i class="fa fa-heart {{ $movie->is_favored ? 'fw-900' : ''}} fa-1x align-self-center movie__fav-icon movie-{{ $movie->id }}"
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="text-white align-self-center"><i class="fa fa-heart fa-1x align-self-center movie__fav-icon"></i></a>
                                    @endauth
                                </div>
