        ...
        <div class="col-md-12">
            <div class="tile mb-4">
                ...
                <div id="movie__upload-wrapper"
                     ...
                     style="display: {{ $errors->any() ? 'none' : 'block' }}; cursor:pointer; border:1px solid #000;text-align: center;padding: 70px;"
                >
                ...
                >
                    ...
                    <div class="form-group">
                        <button type="submit" id="movie__submit-btn" style="display:  " class="btn btn-primary"><i class="fa fa-plus"></i> Publish</button>
                    </div>
